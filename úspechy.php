...
<body>
    ...
    <div class="uspechy">
        <h3>ÚSPECHY</h3>
        <img class="titul" src="img/titul1.jpg" alt="laliga">
        <h2>LA LIGA</h2>
        <h2>35x</h2>
        ...
        <img class="titul" src="img/titul4.jpg" alt="supercopa de espana">
        <h2>SUPERCOPA dE ESPAÑA</h2>
        <h2>12x</h2>
        <p>1988, 1989, 1990, 1993, 1997, 2001, 2003, 2008, 2012, 2017, 2019–20, 2021-22</p>

        <img class="titul" src="img/titul5.jpg" alt="majstrovstva sveta klubov">
        <h2>MAJSTROVSTVÁ SVETA KLUBOV</h2>
        <h2>8x</h2>
        <p>1960, 1998, 2002, 2014, 2016, 2017, 2018, 2022</p>

        <img class="titul" src="img/titul6.jpg" alt="europsky superpohar">
        <h2>EURÓPSKY SUPERPOHÁR</h2>
        <h2>5x</h2>
        <p>2002,  2014,  2016,  2017, 2022</p>

        <img class="titul" src="img/titul7.jpg" alt="pohar uefa">
        <h2>POHÁR UEFA</h2>
        <h2>2x</h2>
        <p>1984-85, 1985-86</p>

        <img class="titul" src="img/titul8.jpg" alt="ligovy pohar">
        <h2>LIGOVÝ POHÁR</h2>
        <h2>1x</h2>
        <p>1984-85</p>

        <img class="titul" src="img/titul9.jpg" alt="male majstrovstva sveta">
        <h2>MALÉ MAJSTROVSTVÁ SVETA</h2>
        <h2>2x</h2>
        <p>1952, 1956</p>

        <img class="titul" src="img/titul10.jpg" alt="latinsky pohar">
        <h2>LATINSKÝ POHÁR</h2>
        <h2>2x</h2>
        <p>1955, 1957</p>

        <img class="titul" src="img/titul11.jpg" alt="regionalne majstrovstva">
        ...
        <img class="titul" src="img/titul12.jpg" alt="trofek mancomunados">
        <h2>TROFEJ MANCOMUNADOS</h2>
        <h2>5x</h2>
        <p>1931-32, 1932-33, 1933-34, 1934-35, 1935-36</p>
        

        <img class="titul" src="img/titul13.jpg" alt="najlepsi klub 20. storocia">
